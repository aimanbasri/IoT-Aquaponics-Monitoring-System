...
void printLocalTime(int choice){
  struct tm timeinfo;
  ...
  switch(choice){
    case 1: 
    break;
    case 2: {format = "%H:%M:%S";} // hours, minute, seconds
    break;
    case 3: {format = "%H";}  ;// hours
    break;
    case 4: {format = "%M" ;}// minutes
    break;
    case 5: {format = "%S" ;}// minutes
    break;
    default: {format = "%A, %B %d %Y %H:%M:%S";} // 1 Jan, hours , minutes, seconds
    break;
  }
