...
String scrollingMessage = "Light";
String staticMessage = "This is the..";

String titleMessage = "Light levels (Lux)";
// String dataMessage = "";
...
void OLEDDisplaySetup(String SSID){
  ...
  display.println("IP: 143.167.53.209");
  display.println("Sending to AdafruitIO");
...
void LCDDisplayText(int row, String message, int delayTime, int totalColumns) {
  ...
  lcd.setCursor(0, row);
  String messagewithunit = String(message).concat(" lux");
  lcd.print(messagewithunit);
}
