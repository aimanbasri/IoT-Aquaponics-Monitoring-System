...
string getLocalTime(int choice){
  ...
  switch(choice){
    case 1: strftime(timeStringBuff, sizeof(timeStringBuff), "%d %M %Y", &timeinfo); // hours, minute, seconds
    break;
    case 2: strftime(timeStringBuff, sizeof(timeStringBuff), "%H", &timeinfo); // day month year
    break;
