...
unsigned long adafruitIODelay = 300000;  // pushed to IO every 10s
...
void loop() {
 ...
 // Water temperature sensors
  ...
  lcd.print(titleMessage);
  LCDDisplayText(1, String(phvalue), 250, 16);
  // LCDDisplayText(0, "Water pH level:", 250, 16);
  // LCDDisplayText(1, "6.2", 250, 16);
