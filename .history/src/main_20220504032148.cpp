...
unsigned long lastdatalog = 300000;  // logs every 5 minute
unsigned long lastIOPush = 10000;  // pushed to IO every 10s
...
void loop() {
 ...
 // Water temperature sensors
  ...
  //delay(10000);
  if (currentMillis % adafruitIODelay == 0) {
    //do x
  ...
  else if (currentMillis % datalogDelay == 0){
