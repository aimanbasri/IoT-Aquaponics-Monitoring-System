...
unsigned long datalogDelay = 300000;  // logs every 5 minute = 300000
unsigned long adafruitIODelay = 60000;  // pushed to IO every 1 min = 60000
...
void loop() {
 ...
 // Water temperature sensors
  ...
  string currtemp = to_string(temp)
  lcd.setCursor(0, 0);
  lcd.print(staticMessage);
  LCDDisplayText(1, to_string(temp), 250, 16);
